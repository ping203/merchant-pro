        ...
        >
          ...
          <RouterWithRedux >
            <Scene key="root">
              ...
              <Scene key="historyTransfer" component={HistoryTransfer} hideNavBar={true}/>
              <Scene key="transfer" component={Transfer} animationStyle={animationStyle} hideNavBar={true}/>
              <Scene key="cashOut" component={CashOut} hideNavBar={true}/>
              <Scene key="mobileCards" component={MobileCards} hideNavBar={true}/>
              <Scene key="itemsCashOut" component={ItemsCashOut} hideNavBar={true}/>
              <Scene key="merchants" component={Merchants}/>
              <Scene key="historyTransferMerchant" component={HistoryTransferMerchant} hideNavBar={true}/>
              <Scene key="cashOutHistory" component={CashOutHistory} hideNavBar={true}/>
